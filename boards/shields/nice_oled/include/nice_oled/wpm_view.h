...
#define NICE_OLED_WPM_VIEW_RESPONSIVE  2
#define NICE_OLED_WPM_VIEW_NUMBER      3
#define NICE_OLED_WPM_VIEW_SPEEDOMETER 4
#define NICE_OLED_WPM_VIEW_GRAPH       5
#define NICE_OLED_WPM_VIEW_COUNT       6
